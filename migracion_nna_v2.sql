...
ALTER TABLE nna ADD COLUMN IF NOT EXISTS pertenece_indigena    BOOLEAN DEFAULT FALSE;
ALTER TABLE nna ADD COLUMN IF NOT EXISTS comunidad_indigena    VARCHAR(100);
